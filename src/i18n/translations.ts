...
const translations = {
  pt: {
    ...
    validation_valid_until: 'Válida até',
    validation_access_slot: 'Acesso {n} de {total}',
    validation_pending_account: 'Aguardando vínculo da conta MT5',
  ...
  es: {
    ...
    validation_valid_until: 'Válida hasta',
    validation_access_slot: 'Acceso {n} de {total}',
    validation_pending_account: 'Pendiente de vincular cuenta MT5',
